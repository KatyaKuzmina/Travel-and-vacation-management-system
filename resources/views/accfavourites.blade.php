...
<div class="gallery">
  <div class="zoom">
    ...
    <center><button id="view" class="button" onclick="Like({{ $accommodations->id }})"><span>{{ __('messages.Like')}}</span></button></center>
    </figure>
    </div>
</div>
<td>
...
<script>
    function Like(accommodationID) {
        ...
        $sql = "INSERT INTO fav_accommodations (user_id, accommodation_id) VALUES ('$userid', '$accommodationid')";
...
<form method="POST" action="{{action([App\Http\Controllers\AccommodationController::class, 'like'],$accommodations->id ) }}">
